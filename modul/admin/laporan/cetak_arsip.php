...
ob_clean(); // Menghindari output awal
...
<head>
    <meta charset="UTF-8">
    <title>Cetak Laporan Arsip Rapat</title>
    <style>
        body {
...
<body onload="window.print()">
    ...
    <table>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="6" style="text-align:center;">Tidak ada data arsip ditemukan.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
