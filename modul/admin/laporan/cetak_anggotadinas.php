...
$isAktif = $_GET['isAktif'] ?? '';

// Ambil data langsung dari tabel anggotadinas
...
<head>
    <meta charset="UTF-8">
    <title>Cetak Laporan Anggota Dinas</title>
    <style>
        body {
    ...
    <div class="kop">
        <div class="kop-container">
            ...
            <div class="kop-text">
                ...
                <p>Jalan Lambung Mangkurat, Kel. Kertak Baru Ilir, Kec. Banjarmasin Tengah<br>Kota Banjarmasin, Kalimantan Selatan - 70114</p>
            </div>
        </div>
        <div class="line"></div>
    </div>

    <h3>LAPORAN ANGGOTA DINAS</h3>

    <?php if (!empty($instansi) || $isAktif !== ''): ?>
        <p class="sub">
            <?php if (!empty($instansi)) echo "Instansi: <strong>" . htmlspecialchars($instansi) . "</strong><br>"; ?>
            <?php if ($isAktif !== '') echo "Status: <strong>" . ($isAktif == '1' ? 'Aktif' : 'Tidak Aktif') . "</strong>"; ?>
        </p>
    <?php endif; ?>
