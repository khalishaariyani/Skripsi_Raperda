...
ob_clean(); // Bersihkan output buffer agar tidak ada karakter sebelum HTML
...
<head>
    <meta charset="UTF-8">
    <title>Cetak Laporan Dokumentasi</title>
    <style>
        body {
...
<body onload="window.print()">
    ...
    <h3>Laporan Dokumentasi Kegiatan</h3>
    <?php if (!empty($bulan)): ?>
    ...
    <table>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="6" style="text-align:center;">Tidak ada dokumentasi ditemukan.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
