...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const notifications = {
    success: {
      icon: "success",
      title: "Berhasil",
      text: (obj) => `Operasi pada ${getObjName(obj)} berhasil dilakukan.`,
    },
    added: {
      icon: "success",
      title: "Sukses",
      text: (obj) => `${capitalize(getObjName(obj))} berhasil ditambahkan.`,
    },
    updated: {
      icon: "success",
      title: "Diperbarui",
      text: (obj) => `${capitalize(getObjName(obj))} berhasil diperbarui.`,
    },
    deleted: {
      icon: "success",
      title: "Terhapus",
    ...
    error: {
      icon: "error",
      title: "Kesalahan",
      text: (obj) => `Terjadi kesalahan saat memproses ${getObjName(obj)}.`,
    },
    failed: {
      icon: "error",
      title: "Gagal",
      text: (obj) => `Tidak dapat menyimpan ${getObjName(obj)} ke database.`,
    },
    kosong: {
      icon: "warning",
    ...
    not_found: {
      ...
      text: (obj) =>
        `${capitalize(getObjName(obj))} tidak ditemukan atau tidak tersedia.`,
    },
    upload_success: {
      icon: "success",
  ...
  if (msg && notifications[msg]) {
    ...
    Swal.fire({
      icon: notif.icon,
      title: notif.title,
      text: typeof notif.text === "function" ? notif.text(obj) : notif.text,
      timer: 2000,
...
function getFKBlockedText(obj) {
  const map = {
    jadwalrapat: "Jadwal tidak dapat dihapus karena sudah digunakan di arsip.",
  ...
  return map[obj] || "Data tidak dapat dihapus karena digunakan di modul lain.";
}
